        ...
        <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 text-white">
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <p class="max-w-xs mt-4 text-sm text-gray-400 flex gap-2">
                <img src={Phone} alt="" />
              ...
              <div class="flex mt-8 space-x-6 text-gray-100 cursor-pointer ">
                <a
                  class="hover:opacity-75 hover:translate-y-[-5px]"
                  href
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <p class="mt-8 text-xs text-gray-200">© 2022 FYLO</p>
        </div>
      </footer>
    </div>
  );
